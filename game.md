...
5. !주식 <kbd>종목명</kbd> → `!주식 삼성전자`
  - `!주식 검색`으로 나오는 데이터에 추가적인 종목 정보를 보여줍니다.
  - 주식 링크, 보유 수량, 최대 보유자(`대주주`)를 알 수 있습니다.
6. !주식 <kbd>종목명</kbd> <kbd>매수|매도</kbd> <kbd>수량:숫자</kbd> → `!주식 삼성전자 매수 4` 또는 `!주식 현대차 매도 2`
...
8. !주식 <kbd>순위|서버순위</kbd> <kbd>유저거래|유저수익|종목거래|종목수익</kbd>
