...
- !청소 `개수:숫자` `@멘션|#태그`
  - 관리자 권한이 있을 때 개수 뒤에 @멘션 또는 #태그로 청소할 유저를 지정할 수 있습니다.
...
- !뮤트 목록 `페이지:숫자`
  ...
  - 모든 대상을 보여주진 않으므로 영구 뮤트는 디스코드의 서버 차단 기능을 사용하고 뮤트를 해제하세요.
- !뮤트 해제 `아이디`
  - 뮤트한 대상이 서버를 나가 멘션할 수 없을 때 아이디로 뮤트를 해제할 수 있습니다.
  - 뮤트 목록에서 보여주는 아이디를 입력하여 해제합니다.
- `!로그 뮤트`로 명령어 사용내역을 기록할 수 있습니다.

> !뮤트 @테스트#1234 \
> !뮤트 목록 \
> !뮤트 해제 123456789098765432
